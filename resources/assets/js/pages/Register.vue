      ...
      meta: [
        {
          name: "description",
          content:
            "YouTube動画の切り抜きまとめサイト、YouClipの新規登録ページです。ゲーム実況やVTuberの動画などから、お気に入りの場面の切り抜きまとめを誰でも簡単に作ることが出来ます。また、みんなが作った人気の切り抜きまとめを見ることも可能です。",
        },
        {
        ...
        },
        {
          ...
          content:
            "YouTube動画の切り抜きまとめサイト、YouClipの新規登録ページです。ゲーム実況やVTuberの動画などから、お気に入りの場面の切り抜きまとめを誰でも簡単に作ることが出来ます。",
        },
        {
          property: "og:image",
          content:
