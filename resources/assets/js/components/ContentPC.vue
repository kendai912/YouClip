<template>
  <div v-if="contentWidth >= 6">
    <div
      ...
      v-bind:class="
        listIndex == contentIndex
          ? 'left-triangle-of-watch-now-playing'
          : 'left-triangle-of-watch'
      "
    ...
    <div
      v-bind:class="
        listIndex == contentIndex
          ? 'highlight-content-of-watch-now-playing'
          : 'highlight-content-of-watch'
      "
      v-bind:style="
        'left: calc(' +
          contentLeft +
    ...
    <div
      ...
      v-bind:class="
        listIndex == contentIndex
          ? 'right-triangle-of-watch-now-playing'
          : 'right-triangle-of-watch'
      "
