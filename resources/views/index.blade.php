...
<head>
  ...
  <meta name="description" content="YouClip(ユークリップ)はYouTube動画のまとめ作成ツールです。もう一度見たいお気に入りの場面を、まとめて残すことが出来ます。みんなのまとめを見ることも可能です。みんなで面白い・役に立つまとめ動画を作りましょう！">
  ...
  <meta property="og:description" content="YouClipはYouTube動画のまとめ作成ツールです。お気に入りの場面をまとめて残すことが出来ます。みんなのまとめを見ることも可能です">
  ...
  <meta name="twitter:description" content="YouClipはYouTube動画のまとめ作成ツールです。お気に入りの場面をまとめて残すことが出来ます。みんなのまとめを見ることも可能です">
